package com.fatihmayuk.kartaca.backend.security;
...
@Component   //SINGLETON BIR INSTANCE OLUSTURMA KISMINI IMPLEMENTE EDIYORUZ.
public class JwtTokenUtil {

    // 1Gün    MILISANIYE CINSINDEN
    public static final long ACCESS_TOKEN_VALIDITY_SECONDS = 24 * 60 * 60 * 1000;
    public static final String SIGNING_KEY = "fatihm";
